...
class ColapsedOnEscherichiaSpeciesLevel(models.Model):
    gene1 = models.CharField(max_length = 50 )
    gene2 = models.CharField(max_length = 50 )
    together  = models.IntegerField()
    first_only  = models.IntegerField()
...
class ColapsedOnEscherichiaStrains(models.Model):
    gene1 = models.CharField(max_length = 50 )
    gene2 = models.CharField(max_length = 50 )
    together  = models.IntegerField()
    first_only  = models.IntegerField()
...
class ColapsedOnEscherichiaStrainWithingSpecies(models.Model):
    gene1 = models.CharField(max_length = 50 )
    gene2 = models.CharField(max_length = 50 )
    together  = models.IntegerField()
    first_only  = models.IntegerField()
