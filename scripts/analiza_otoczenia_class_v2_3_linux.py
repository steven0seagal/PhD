...
"""
Thing to add:
--> At the end add to DataFrame short description about domains !!! <== IT IS URGENT !!!@#$ 
...
#        neighbourhood_complete.append(party)
    ...
    def DataForWilcoxonTest(self, first_list, second_list,matrix,genome):
    ...
    def GO(self):
        ...
        for file in file_names:
            ...
            for point in coords:
                ...
                self.DataForWilcoxonTest(D_LOK,D_GLOB,matrix,file)
