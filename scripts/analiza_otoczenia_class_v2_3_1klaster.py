...
class NeighbourhoodAnalyzer():
    ...
    def SaveComplete(self,file, message_for_output,message_for_additional_data, message_down,complete_data):
        ...
        with open('/home/klaster/neighborhood_analyzer/'+file+'.txt' , 'w') as output_file:
...
#        neighbourhood_complete.append(party)
    ...
    def GO(self):
        ...
        mighty_domains= self.OpenDirectory('/home/klaster/neighborhood_analyzer/LISTA_DOMEN')
        print("Opening domain list")
        GENOME_ID_SIZE_IN_BP = self.OpenFile('/home/klaster/neighborhood_analyzer/GENOME_ID_SIZE_IN_BP')
        print("Opening genome size in bp list")
        GENOME_ID_SIZE_IN_GENE = self.OpenFile('/home/klaster/neighborhood_analyzer/GENOME_ID_SIZE_IN_GENE')
        ...
        if self.user_OrganismValue   == "escherichia":
            ...
            tax = "Shigella"
        elif self.user_OrganismValue ==  "rhizobium":
            tax = "Rhizobium"
        elif self.user_OrganismValue == "sinorhizobium":
            tax = "Sinorhizobium"
        ...
        ################################################################################
        #LINUX
        file_names = self.OpenDirectory('/home/klaster/neighborhood_analyzer/'+tax)
        ...
        domain_information = self.OpenInformationBoutDomains('/home/klaster/neighborhood_analyzer/domain_information')
