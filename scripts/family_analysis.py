...
class NeighFamilyAnalysis:
    ...
    def compress_all_data(self, lista_plikow):
        ...
        for file in ' '.join(lista_plikow).split(','):
            # print(file)
            # LOCAL
            # file_path = '/mnt/d/45.76.38.24/final_site-project/media/results/temp/' + file + ".txt"
            # VULTR
            file_path = '/home/djangoadmin/final_site-project/media/results/temp/' + file 
            try:
            ...
            for line in data.iterrows():
                ...
                # dane_do_tabeli = []
                # print(lista_wynikow)
                zbiorcze_dane.loc[row_counter] = [file, lista_wynikow[0], lista_wynikow[1],
