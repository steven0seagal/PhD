...
########################################################################################################################
    ...
    def GO(self):
        ...
        mighty_domains= self.OpenDirectory('/mnt/d/45.76.38.24/final_site-project/important_files/LISTA_DOMEN.txt')
        ...
        message_for_additional_data = "Pfam domain , PVALUE,  occurence in neighbourhoods, " \
                                      ...
                                      "average occurence in genome, avg DLOK-DGLOB, Family, Summary"
        ...
        # LOCAL
        file_names = self.OpenDirectory('/mnt/d/45.76.38.24/final_site-project/important_files/'+tax+'.txt')
        ...
        print("Calculationstart", datetime.datetime.now())
        ...
        print("Calculation over", datetime.datetime.now())
        ###############################################################################################################
        ###############################################################################################################
        ...
        self.SaveComplete(self.user_PfamDomain, message_for_output, message_for_additional_data,
