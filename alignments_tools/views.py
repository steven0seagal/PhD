...
def makeitsimple(request):
    ...
    if request.user.is_authenticated:
        ...
        if request.method =='POST':
            ...
            query = ColapserDatabase(insert_file = '/media/'+name, user_id = user_id, out_time = 'NOW', link = link_ready,anal_name = out_name)
            query.save()
...
def strechitout(request):
    ...
    if request.method =='POST':
        ...
        fs = FileSystemStorage()
        name_master = '/media/'+fs.save(uploaded_file_master.name, uploaded_file_master)
        name_slave1 = '/media/'+fs.save(uploaded_file_slave1.name, uploaded_file_slave1)
        name_slave2 = '/media/'+fs.save(uploaded_file_slave2.name, uploaded_file_slave2)
        ...
        # Vultr
        ready_script = '/home/djangoadmin/final_site_venv/bin/python3 /home/djangoadmin/final_site-project/scripts/execute_order_69.py {} {} {} {}'.format(name_master, name_slave1,name_slave2, link_down)
